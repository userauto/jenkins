pipeline {
    ...
    post {
        ...
        failure {
            sh 'curl -X POST -H "Content-Type: application/json" -d \'{"chat_id": "884174870", "text": "[💀FAILED] build failed!", "disable_notification": false}\' https://api.telegram.org/bot7094254109:AAF1KYBKvInh252FPJAaq0gG3EeH1qmnUFI/sendMessage'
        }
    }
}